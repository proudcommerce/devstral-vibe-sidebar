...
This guide will get you up and running with the Devstral Vibe Sidebar extension in under 5 minutes.
...
**Important for macOS users:** If you don't have Xcode Command Line Tools, install them:
```bash
...
1. Look for the Devstral Vibe icon in the left sidebar (activity bar)
2. Click it to open a terminal in the sidebar
3. The terminal automatically runs `vibe` for you
4. Start chatting with Devstral in the real terminal!

## That's It!

You now have Devstral Vibe integrated into your VS Code sidebar.
